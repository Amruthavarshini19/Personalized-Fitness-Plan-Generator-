...
# ══════════════════════════════════════════
    ...
    # ══ INPUT ══
        ...
        with st.container():
            ...
            h, w = st.columns(2)
            with h: height = st.number_input("Height (cm)", value=170.0)
            with w: weight = st.number_input("Weight (kg)", value=70.0)
        ...
        if st.button("Generate Complete Plan →"):
            ...
            with st.spinner("AI is engineering your plan..."):
                ...
                st.session_state.user_data = {"name": name, "bmi": bmi, "status": status, "color": color, "goal": goal}
